...
bcoin.MainchainClient = require('./client/mainchain');
...
// Sidechain
bcoin.sidechain = require('./sidechain');
bcoin.SidechainObject = require('./sidechain/sidechain');
bcoin.Withdrawal = require('./sidechain/withdrawal');
bcoin.WithdrawalBundle = require('./sidechain/withdrawalbundle');
bcoin.Deposit = require('./sidechain/deposit');
