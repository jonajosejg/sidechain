/*!
 * bcoin.js - a javascript bitcoin sidechain library.
...
// BMM
bcoin.define('bmm', './bmm');
bcoin.define('BMMCache', './bmm/cache');
...
bcoin.define('MainchainClient', './client/mainchain');
...
// Sidechain
bcoin.define('sidechain', './sidechain');
bcoin.define('SidechainObject', './sidechain/sidechain');
bcoin.define('Deposit', './sidechain/deposit');
bcoin.define('Withdrawal', './sidechain/withdrawal');
bcoin.define('WithdrawalBundle', './sidechain/withdrawalbundle');
