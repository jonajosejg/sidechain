...
class ChainEntry {
  ...
  /**
   * Get little-endian withdrawal bundle hash.
   * @returns {Hash}
   */
  ...
  /**
   * Get little-endian mainchain block hash.
   * @returns {Hash}
   */

  mainchainBlock() {
    return util.revHex(this.mainchainBlock);
  }
  ...
  fromRaw(data) {
    ...
    const hash = hash256.digest(br.readBytes(148));
