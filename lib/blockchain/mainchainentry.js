/*!
 * mainchainentry.js - mainchainentry object for bitcoin
 ...
 * @alias module:blockchain.MainchainEntry
 * @property {Hash} hash
...
class MainchainEntry {
   ...
   * @param {Object} options
   * @param {MainchainEntry} prev - Previous entry.
   * @returns {MainchainEntry}
   */
  ...
  getProof() {
    ...
    return MainchainEntry.MAX_CHAINWORK.div(target.iaddn(1));
  }
  ...
  fromRaw(data) {
    ...
    const hash = hash256.digest(br.readBytes(180));
  ...
  static isMainchainEntry(obj) {
    return obj instanceof MainchainEntry;
  }
}
...
MainchainEntry.MAX_CHAINWORK = new BN(1).ushln(256);

/*
 * Expose
 */

module.exports = MainchainEntry;
