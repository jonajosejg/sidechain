...
class MempoolEntry {
   ...
   * @param {Buffer} options.withdrawalID - Withdrawal Transaction ID
  ...
  fromOptions(options) {
    ...
    this.withdrawalRefund = options.withdrawalRefund;
