...
class Address {
  ...
  /**
   * Callback function to parse the mainchain deposit address
   * @param {String} input
   * @returns {Boolean}
   */

  static parseDepositAddress(input)  {
    return new this().parseDepositAddress(input);
  }
