...
/**
 * Default payment amount to mainchain miner for commiting
 * critical data to the mainchain
 * @const {Amount}
 * @default
 */

exports.CRITICAL_DATA_AMT = 0.0001 * exports.COIN;

/**
 * Default fee rate for sidechain deposits on this sidechain
 * @const {Amount}
 * @default
 */

exports.SIDECHAIN_DEPOSIT_FEE = 0.00001 * exports.COIN -  0.0000000000001;
...
/**
 * Commitment hash of the sidechain build used as an identifier for sidechain
 * proposal creation on the mainchain daemon labeled hashID1 (32bytes)
 * @const {String}
 * @default
 */

exports.SIDECHAIN_BUILD_TAR_HASH = '15eda1257f8efcfded8a2ccbbdd756b2' +
                                   '9797f2c7f4174c9ef43d5667ac570374';

/**
 * Build commitment hash used in the mainchain daemon labeled hashID2 (20bytes)
 * @const {String}
 * @default
 */

exports.SIDECHAIN_BUILD_COMMIT_HASH = 'a67a177c615cf2e228ab4027faa48a745e448c38';
...
exports.verifyPOW = function verifyPOW(hash) {
