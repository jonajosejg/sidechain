/*!
 * policy.js - bitcoin constants for testchain
...
/**
 * Maximum weight to be mined for withdrawals
 * @const {Number}
 * @default
 */

exports.MAX_WITHDRAWAL_WEIGHT = 400000 / consensus.WITNESS_SCALE_FACTOR;

/**
 * Maxmium weight value for withdrawal bundle transactions
 * @const {Number}
 * @default
 */

exports.MAX_WITHDRAWAL_BUNDLE_WEIGHT =  (exports.MAX_WITHDRAWAL_WEIGHT / 2);

/**
 * Workscore number required for mainchain payout
 * @const {Number}
 * @default
 */

exports.MIN_MAINCHAIN_WORKSCORE = 13150;

/**
 * Minimum number of pooled withdrawals
 * to create a new bundle
 * @const {Number}
 * @default
 */

exports.MIN_WITHDRAWAL_BUNDLE = 10;

/**
 * Temporary value for withdrawals that failed.
 * @const {Number}
 * @default
 */

exports.FAILED_WITHDRAWAL_WAIT_PERIOD = 20;

/**
 * Key address for fee script
 * @const {String}
 * @default
 */

exports.FEE_KEY = '5f8f196a4f0c212fee1b4eda31e3ef383c52d9fc';
