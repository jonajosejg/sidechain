...
class Script {
  ...
  /**
   * Test wheter the current output script is a sidechain object
   * @returns {Boolean}
   */
  ...
  fromPreviousBlockCommitment(hash) {
  ...
  /**
   * Create a previousblock commitment script.
   * @param {Buffer} hash
   * @returns {Script}
   */

  static fromPreviousBlockCommitment(hash) {
    return new this().fromPreviousBlockCommitment(hash);
  }
