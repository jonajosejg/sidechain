 ...
 * for the different withdrawal bundle statuses, zones
 */
...
class WithdrawalBundle extends SidechainObject {
  ...
  fromOptions(options) {
    ...
    if (options.obj != null) {
      assert(Buffer.isBuffer(options.obj));
  ...
  async hasLatestWithdrawalBundle(hash) {
    return this.db.getLatestWithdrawalBundle(hash);
  }
  ...
  getWithdrawalBundleCommitment() {
    return this.script.getWithdrawalBundleHashCommitment();
  }
